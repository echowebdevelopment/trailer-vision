...
<head>
	...
	<style type="text/css">
		...
		body {
			font-family: "sofia-pro", sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji" !important;
		}

		body.yith-woocompare-popup h1 {
			text-transform: none !important;
			color: #0D311F !important;
		...
		table.compare-list .product_info .remove-compare-item {
...
<body <?php body_class('woocommerce yith-woocompare-popup'); ?>>
	...
	<h1><?php echo wp_kses_post($table_text); ?></h1>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function ($) {
			...
			// $(".remove-compare-item").on("click", function (e) {
			// 	e.preventDefault();

			// 	var iframe = $("iframe"); // Adjust selector if needed
			// 	if (iframe.length) {
			// 		iframe.remove();
			// 	}
			// });
