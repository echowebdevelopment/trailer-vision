...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Payment Area', 'understrap' ),
				'id'            => 'footer-payment-icons',
				'description'   => __( 'Payment Area footer widgets', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="site-footer__payment-area-widget %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
		...
		register_sidebar(
			array(
				...
				'before_widget' => '<div id="%1$s" class="site-footer__disclaimer-widget %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
