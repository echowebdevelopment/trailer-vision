...
if (!function_exists('understrap_scripts')) {
	...
	function understrap_scripts()
	{
		...
		wp_enqueue_style('lightgallery_css', get_template_directory_uri() . '/css/lightgallery-core.css');

		wp_enqueue_script('jquery');

		wp_enqueue_script('tinyslider_js', get_template_directory_uri() . '/js/tiny-slider.js', array('jquery'));
		wp_enqueue_script('lightgallery_js', get_template_directory_uri() . '/js/lightgallery.umd.js', array('jquery'));
